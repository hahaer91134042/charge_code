...
namespace Eki_Web_MVC
{
    ...
    public class SerialNumUtil
    {
        ...
        //{   //這樣沒有特殊碼才能給支付公司使用
        //    return $"{AppConfig.CPSFlag}{TimeUtil.toStamp(DateTime.Now)}{RandomUtil.GetRandonNumStr(4)}";
        //}
        //public static string EkiOrderSerialNum()
        //{   //這樣沒有特殊碼才能給支付公司使用
        //    return $"{AppConfig.EkiFlag}{TimeUtil.toStamp(DateTime.Now)}{RandomUtil.GetRandonNumStr(4)}";
        //}
        //目前棄用
        //public static string OrderSerialNum()
        //{
        ...
        {
            var keyNum = Convert.ToDecimal(TextUtil.StrASC(AppConfig.PrivateSecret));
            int result;
            string serialNum = "";
            do
            {
        ...
        public static bool isLocationSerialNum(string serialNum)
        {
            try
            {
                var keyNum = TextUtil.IntASC(AppConfig.PrivateSecret);
