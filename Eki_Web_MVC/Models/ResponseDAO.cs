...
{
    public abstract class ResponseDAO:IBaseDAO
    {
        private EkiErrorCode code;

        public ResponseDAO(EkiErrorCode code,bool b) : this(b)
        {
            this.code = code;
        }
        public ResponseDAO(bool successful)
        {
            success = successful;
            if (!successful)
            {
        ...
        public ResponseDAO setErrorCode(EkiErrorCode code)
        {
