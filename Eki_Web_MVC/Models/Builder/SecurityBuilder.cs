...
namespace Eki_Web_MVC
{
    ...
    public class SecurityBuilder
    {
        ...
        public static string CreateEkiSecretHash(string secret, HashFormat format = HashFormat.SHA256)
        {
        ...
        public static string CreatePasswordHash(string saltkey, string password, HashFormat format = HashFormat.SHA1)
        {
        ...
        public static string CreateHashCode(HashFormat format, params string[] values)
        {
        ...
        public static string EncryptTextToBase64(string data, ICryptoTransform transform)
        {
        ...
        public static string DecryptTextFromBase64(string cipher, ICryptoTransform transform)
        {
